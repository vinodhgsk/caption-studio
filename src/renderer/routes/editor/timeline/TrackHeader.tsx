...
export function TrackHeader({ track, heightPx }: TrackHeaderProps): JSX.Element {
  ...
  return (
    <div
      className="group flex items-center justify-between border-b border-line px-3 text-text-secondary bg-surface-2/60 hover:bg-surface-2/90 transition-all select-none"
    ...
    >
      ...
      {/* Right side: Actions (Lock + Hide/Mute + Delete on hover) */}
